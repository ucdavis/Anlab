...
describe('<LabFields />', () => {
    it('should render an input', () => {
        ...
        const target = mount(<LabFields labComments="Test" adjustmentAmount={0} handleChange={handleChange} />);
    ...
    describe('<Input/> ', () => {
        ...
        it('should have have a value of Test1', () => {
            const handleChange = jasmine.createSpy('handleChange');
            const target = mount(<LabFields labComments="Test1" adjustmentAmount={0} handleChange={handleChange} />);
            const input = target.find('Input').at(0);
        ...
        it('should have have a value of Test2', () => {
            const handleChange = jasmine.createSpy('handleChange');
            const target = mount(<LabFields labComments="Test2" adjustmentAmount={0} handleChange={handleChange} />);
            const input = target.find('Input').at(0);
    ...
    describe('<NumberInput/> ', () => {
        ...
        it('should have have a value of 0.01', () => {
            const handleChange = jasmine.createSpy('handleChange');
            const target = mount(<LabFields labComments="Test1" adjustmentAmount={0.01} handleChange={handleChange} />);
            const input = target.find('NumberInput').at(0);
        ...
        it('should have have a value of 500', () => {
            const handleChange = jasmine.createSpy('handleChange');
            const target = mount(<LabFields labComments="Test1" adjustmentAmount={500} handleChange={handleChange} />);
            const input = target.find('NumberInput').at(0);
