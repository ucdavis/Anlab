...
export default class Summary extends React.PureComponent<ISummaryProps, {}> {
  public render() {
    ...
    const infoText =
      "You will be able to review this information before placing your order";
    const errorText =
      "Please correct any errors and complete any required fields before you proceed";
          ...
          <div>
            <h3>
              ...
              <NumberFormat
                ...
                {...numberFormatOptions}
              />{" "}
              ({this.props.clientType === "uc" ? "UC Rate" : "Non UC Rate"})
            </h3>
            <a
              role="button"
        ...
        <div className="collapse" id="testSummary">
          <div className="well">
            <table className="table">
              ...
              <tfoot>
                <tr>
                  ...
                  <td>
                    <NumberFormat
                      value={this.props.processingFee}
                      {...numberFormatOptions}
                    />
                  </td>
                </tr>
            ...
            {this.props.canSubmit ? (
              <div className="alert alert-info">{infoText}</div>
            ) : null}
    ...
    if (this.props.placingOrder) {
      return (
        <Button
          ...
          disabled={!this.props.canSubmit || this.props.isSubmitting}
  ...
  private _renderTests = () => {
    ...
    return this.props.selectedTests.map((item) => {
      ...
      const setupCost = isUcClient
        ? item.internalSetupCost
        : item.externalSetupCost;
      ...
      return (
        <tr key={item.id}>
          <td>{item.analysis}</td>
          <td>
            <NumberFormat value={price} {...numberFormatOptions} />
          </td>
          <td>
            <NumberFormat value={perTest} {...numberFormatOptions} />
          </td>
          <td>
            <NumberFormat value={setupCost} {...numberFormatOptions} />
          </td>
          <td>
            <NumberFormat value={rowTotalDisplay} {...numberFormatOptions} />
          </td>
        </tr>
      );
    });
