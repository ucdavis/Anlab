export function getOptions(useCoa: boolean) {
    return {
        ...
        UCSF: {
            detail: "Loc(1) - BusinessUnit(5) - Acct(5) - Fund(4) - DeptID(6) - Proj(7) - Activity(2) - Function(2) - Flex(6)",
        ...
        UCLA: {
            detail: "Loc(1) - Acct(6) - CostCenter(2) - Fund(5) - Project(1-6) - Sub(2) - Object(4) - Src(1-6) ",
            example: "4-123456-A1-12345-123456-12-1234-A23456",
            name: "UCLA",
        },
        UCR: {
            detail: "Loc(1) - Acct(6) - Activity(6) - Fund(5) - Func(2) - CostCenter(4/5) - Proj(5)",
        ...
        UCSC: {
            detail: "Loc(1) - Fund(5) - Org(6) - Acct(6) - Prog(2) - Activity(1-6) - DocRef(1-6)",
        ...
        UCI: {
            detail: "Loc(1) - Acct(7) - Fund(5) - Sub(2) - Obj(4) - Ref(1-10) - Src(1-6) - Proj(1-6)",
            example: "9-A234567-12345--12-A234-A234567890-A23456-A23456",
            name: "UCI",
        },
        UCM: {
            detail: "Loc(1) - Acct(6) - CostCenter(2) - Fund(5) - Proj(1-6) - Sub(2) - Obj(4) - Src(1-6)",
