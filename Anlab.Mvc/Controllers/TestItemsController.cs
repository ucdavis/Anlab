...
namespace AnlabMvc.Controllers
{
    ...
    public class TestItemsController : ApplicationController
    {
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Id, Categories, Analysis,Group,Public,Notes,AdditionalInfoPrompt,LabOrder,RequestOrder")] TestItem testItem)
        {
            if (id != testItem.Id)
            {
                return NotFound();
