...
namespace AnlabMvc.Controllers
{
    ...
    public class TestItemsController : ApplicationController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Analysis,AnalysisMethodNumber,Categories,Group,Public,Notes")] TestItem testItem)
        {
            ModelState.Clear();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id, Categories, Analysis, AnalysisMethodNumber, Group,Public,Notes")] TestItem testItem)
        {
            if (id != testItem.Id)
            {
                return NotFound();
