    ...
    public class OrderService : IOrderService
    {
        ...
        public void UpdateAdditionalInfo(Order order)
        {
            ...
            if (orderDetails.SampleType == TestCategories.Water)
            {
                ...
                //sb.AppendFormat("{0}: {1}{2}", "Water reported in mg/L", orderDetails.SampleTypeQuestions.WaterReportedInMgL.ToYesNoString(), Environment.NewLine); //For not they don't want this question.
            }
