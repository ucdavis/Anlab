...
namespace Test.TestsController
{
    ...
    public class ApplicationControllerReflectionTests
    {
        private readonly ITestOutputHelper output;
        public ApplicationControllerReflectionTests(ITestOutputHelper output)
        {
            this.output = output;
        }
        protected readonly Type ControllerClass = typeof(ApplicationController);
        ...
        public void TestControllerHasAutoValidateAntiforgeryTokenAttribute()
        {
            ...
            #region Assert
            result.Count().ShouldBeGreaterThan(0, "AutoValidateAntiforgeryToken not found.");
            #endregion Assert
        }
